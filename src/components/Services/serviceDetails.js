...
function Services() {
  return (
    <div className="flex flex-col items-start justify-start relative overflow-hidden w-full bg-white">
      <h1 className="text-gray-900 font-bold text-5xl my-8 text-center w-full"> {/* Increased font size */}
        Our Services
      </h1>

      <p className="text-gray-700 text-left mb-6 max-w-4xl self-center text-lg"> {/* Increased font size */}
...
const ServiceCard = ({ title, description, benefits, process, image, images }) => (
  <div className="flex flex-col lg:flex-row p-6 rounded-lg w-full bg-gray-100 shadow-md">
    <div className="lg:w-1/2 pr-4">
      <h2 className="text-4xl font-semibold text-gray-800 mb-2 text-left"> {/* Increased font size */}
        {title}
      </h2>
      <p className="text-gray-600 text-left mb-2 text-xl"> {/* Increased font size */}
        {description}
      </p>
      <p className="text-gray-600 text-left text-xl"> {/* Increased font size */}
        <strong>Benefits:</strong> {benefits}
      </p>
      <p className="text-gray-600 text-left mt-1 text-xl"> {/* Increased font size */}
