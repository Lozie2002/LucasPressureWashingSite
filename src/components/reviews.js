    ...
    >
            <div className="flex flex-col items-start justify-start text-left w-full max-w-screen-lg px-5 pt-10">
                <div className="flex w-full flex-col md:w-[100%]">
                    {/* Review Section */}
                    <div className="pt-10">
                        <h2 className="text-3xl md:text-4xl font-semibold text-black pb-4">
                            Customer Reviews
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6"> {/* 3-column layout */}
                            ...
                            <div className="bg-white border p-4 rounded-lg shadow-md">
                                ...
                                <p className="font-semibold text-gray-600 mt-2">— Jane D.</p>
                            </div>
                            ...
                            <div className="bg-white border p-4 rounded-lg shadow-md">
                                ...
                                <p className="font-semibold text-gray-600 mt-2">— John S.</p>
                            </div>
                            ...
                            <div className="bg-white border p-4 rounded-lg shadow-md">
                                ...
                                <p className="font-semibold text-gray-600 mt-2">— Sarah T.</p>
                            </div>
                        </div>
                    </div>
                </div>
